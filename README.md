...
4. ### Setting up local environment:
   - Fork the repository _ First you need your own copy of the project to work
     on. To do that you have to fork the repository. You can find the fork
     button on the top-right side of the browser window. (Refer to the attached
     image) _ After that your own copy will look like
     `<your-user-name>/Cowin-Vaccine-Availablity-Checker`
