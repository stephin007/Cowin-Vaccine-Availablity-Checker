      ...
      return (
          ...
          <h3>Vaccine Name</h3>
                    ...
                    <div className="paper-left_content">
                        <h3>address</h3>
          <p>{vaccine.block_name},
          {vaccine.district_name},
          {vaccine.state_name}</p>
                    </div>
          <div className = "paper-left_content">
          <h3>pincode</h3>
                        <p>{vaccine.pincode}</p>
          ...
          <div className = "close-time time">Closing Time:
              {vaccine.to}</div>
                    </div>
          </div>
          ...
          <div className = "paper-right_age"><div className = "age_text">
          <h3>Minimum Age</h3>
                        </div>
          ...
          <p>{vaccine.min_age_limit} years</p>
                    ...
                    </div><div className = "paper-right_slots">
          <h3>Slots Available<
              /h3>
