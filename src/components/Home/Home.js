...
const Home =
  ...
  variant = "outlined"
          ...
          <FormControl>< Select
variant = "outlined"
value = {districtCode} onChange = {onDistrictChange} > {district.map((state) => (
  ...
  format = "dd-MM-yyyy"
  value = {selectedDate} onChange = {handleDateChange} InputProps =
  {
    { className: classes.input }
      ...
      <Paper className = {classes.paper} elevation = {3}>< TextField
  id = "outlined-number"
  margin = "normal"
  label = "Pin Code"
  type = "number"
